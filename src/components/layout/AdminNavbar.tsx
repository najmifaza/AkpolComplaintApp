        ...
        <div className="flex justify-between h-20">
          <div className="flex">
            <div className="flex-shrink-0 flex items-center">
              ...
              <Link href="/admin/dashboard" className="text-2xl font-black tracking-tight text-white uppercase drop-shadow-sm">
                DUMAS <span className="text-amber-400">AKPOL</span>
                <span className="ml-3 text-xs bg-amber-500 text-slate-900 px-2 py-0.5 rounded-sm font-bold align-middle">ADMIN</span>
              </Link>
            </div>
          </div>
